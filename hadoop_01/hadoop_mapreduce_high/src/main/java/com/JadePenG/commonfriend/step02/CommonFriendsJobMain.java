...
public class CommonFriendsJobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job,
                new Path("H:\\~Big Data\\Employment\\03_大数据阶段\\day05_MapReduce高阶训练及Yarn资源调度\\资源\\共同好友\\output_step1"));
        ...
        TextOutputFormat.setOutputPath(job, new Path("H:\\~Big Data\\Employment\\03_大数据阶段\\day05_MapReduce高阶训练及Yarn资源调度\\资源\\共同好友\\output_step2"));
