...
object TravelTypeEnum extends Enumeration {
  ...
  val OneWay: constants.TravelTypeEnum.Value = Value(0)
  val RoundTrip: constants.TravelTypeEnum.Value = Value(1)
  val Unknown: constants.TravelTypeEnum.Value = Value(-1)
}
